...
time -p python $grampa -s $prost -g $progt -o $proout_full -c 15 -p $grampa_procs
# Full search

echo "# ASTRAL PRO HC"
time -p python $grampa -s $prost -g $progt -o $proout_hc -h1 "$hc_clade" -c 15 -p $grampa_procs
# H1 horseshoe crab branch

echo "# ASTRAL PRO SP"
time -p python $grampa -s $prost -g $progt -o $proout_sp -h1 "$sp_clade" -c 15 -p $grampa_procs
# H1 spider+scorpion branch

echo "# ASTRAL PRO HC+SP"
time -p python $grampa -s $prost -g $progt -o $proout_hcsp -h1 "$hc_clade $sp_clade" -c 15 -p $grampa_procs
...
time -p python $grampa -s $astralst -g $astralgt -o $astralout_full -c 15 -p $grampa_procs
# Full search

echo "# ASTRAL SINGLE COPY HC"
time -p python $grampa -s $astralst -g $astralgt -o $astralout_hc -h1 "$hc_clade" -c 15 -p $grampa_procs
# H1 horseshoe crab branch

echo "# ASTRAL SINGLE COPY SP"
time -p python $grampa -s $astralst -g $astralgt -o $astralout_sp -h1 "$sp_clade" -c 15 -p $grampa_procs
# H1 spider+scorpion branch

echo "# ASTRAL SINGLE COPY HC+SP"
time -p python $grampa -s $astralst -g $astralgt -o $astralout_hcsp -h1 "$hc_clade $sp_clade" -c 15 -p $grampa_procs
# H1 horseshoe crab AND spider+scorpion branches
...
time -p python $grampa -s $multist -g $multigt -o $multiout_full -c 15 -p $grampa_procs
# Full search

echo "# ASTRAL MULTI HC"
time -p python $grampa -s $multist -g $multigt -o $multiout_hc -h1 "$hc_clade" -c 15 -p $grampa_procs
# H1 horseshoe crab branch

echo "# ASTRAL MULTI SP"
time -p python $grampa -s $multist -g $multigt -o $multiout_sp -h1 "$sp_clade" -c 15 -p $grampa_procs
# H1 spider+scorpion branch

echo "# ASTRAL MULTI HC+SP"
time -p python $grampa -s $multist -g $multigt -o $multiout_hcsp -h1 "$hc_clade $sp_clade" -c 15 -p $grampa_procs
# H1 horseshoe crab AND spider+scorpion branches
...
time -p python $grampa -s $balst -g $balgt -o $balout_full -c 15 -p $grampa_procs
# Full search

echo "# BALLESTEROS HC"
time -p python $grampa -s $balst -g $balgt -o $balout_hc -h1 "$hc_clade" -c 15 -p $grampa_procs
# H1 horseshoe crab branch

echo "# BALLESTEROS SP"
time -p python $grampa -s $balst -g $balgt -o $balout_sp -h1 "$sp_clade" -c 15 -p $grampa_procs
# H1 spider+scorpion branch

echo "# BALLESTEROS HC+SP"
time -p python $grampa -s $balst -g $balgt -o $balout_hcsp -h1 "$hc_clade $sp_clade" -c 15 -p $grampa_procs
# H1 horseshoe crab AND spider+scorpion branches
...
time -p python $grampa -s $tradst -g $tradgt -o $tradout_full -c 15 -p $grampa_procs
# Full search

echo "# TRADITIONAL HC"
time -p python $grampa -s $tradst -g $tradgt -o $tradout_hc -h1 "$hc_clade" -c 15 -p $grampa_procs
# H1 horseshoe crab branch

echo "# TRADITIONAL SP"
time -p python $grampa -s $tradst -g $tradgt -o $tradout_sp -h1 "$sp_clade" -c 15 -p $grampa_procs
# H1 spider+scorpion branch

echo "# TRADITIONAL HC+SP"
time -p python $grampa -s $tradst -g $tradgt -o $tradout_hcsp -h1 "$hc_clade $sp_clade" -c 15 -p $grampa_procs
# H1 horseshoe crab AND spider+scorpion branches
