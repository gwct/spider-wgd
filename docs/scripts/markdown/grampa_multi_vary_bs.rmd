...
readGrampa <- function(spec, type, bs, search, label) {
  score_file = here("data", "GRAMPA", paste0(spec, "spec"), "grampa", paste0(type, "-bs", bs, "-", search, "-scores.txt"))
  count_file = here("data", "GRAMPA", paste0(spec, "spec"), "grampa", paste0(type, "-bs", bs, "-", search, "-dup-counts.txt"))
