...
```{r seq-summary-spec, out.width="75%", fig.align = "center", warning=FALSE}
...
spec_p_top = plot_grid(spec_p_16 + theme(legend.position="none"), spec_p_19 + theme(legend.position="none"), ncol=2, labels=c("16 species", "19 species"))
...
aln_data = rbind(aln_data_16, aln_data_19)
...
aln_lens$dataset = factor(aln_lens$dataset, levels=c("16 species", "19 species"), ordered=T)
...
aln_gappy_sites$dataset = factor(aln_gappy_sites$dataset, levels=c("16 species", "19 species"), ordered=T)
...
aln_informative_sites$dataset = factor(aln_informative_sites$dataset, levels=c("16 species", "19 species"), ordered=T)
...
pre_binned = merge(pre_binned_16, pre_binned_19, by="informative.sites")
...
post_binned = merge(post_binned_16, post_binned_19, by="informative.sites")
