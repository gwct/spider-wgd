...
5. Finally, remove any alignments with sequences from fewer than 4 taxa after filtering.
...
8. Remove any samples with premature stop codons.
...
```{r seq-summary-spec, out.width="50%", fig.align = "center", warning=FALSE, eval=F}
...
# Alignment sequence length (codons, ungapped) per alignment
...
```{r informative-sites, out.width="50%", fig.align = "center", warning=FALSE}
