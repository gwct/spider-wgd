...
All searches done on 6359 rooted gene trees.
...
## Full search, bootstrap rearrange 90, 16 species

### Input species tree and score distribution

```{r cds-apro-16-r90-full-scores, out.width="75%", fig.align = "center", warning=FALSE}
...
```{r cds-apro-16-r90-full-trees, out.width="85%", fig.align = "center", warning=FALSE}
