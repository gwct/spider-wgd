...
pro_pep_tree_file = here("data", "trees", "chelicerate-16spec-pep-astral-pro.rooted.tre")
...
multi_pep_tree_file = here("data", "trees", "chelicerate-16spec-pep-astral-multi.rooted.tre")
...
single_pep_tree_file = here("data", "trees", "chelicerate-16spec-pep-astral-single-copy.rooted.tre")
...
#### [Newick tree file (CDS; rooted)](https://github.com/gwct/spider-wgd/blob/main/data/trees/chelicerate-16spec-astral-pro.rooted.tre)

```{r astral-pro-tree-cds, out.width="75%", fig.align = "center", warning=FALSE}
...
```{r astral-pro-tree-pep, out.width="75%", fig.align = "center", warning=FALSE}
...
#### [Newick tree file (CDS; rooted)](https://github.com/gwct/spider-wgd/blob/main/data/trees/chelicerate-16spec-astral-multi.rooted.tre)

```{r astral-multi-tree-cds, out.width="75%", fig.align = "center", warning=FALSE}
...
```{r astral-multi-tree-pep, out.width="75%", fig.align = "center", warning=FALSE}
...
#### [Newick tree file (CDS; rooted)](https://github.com/gwct/spider-wgd/blob/main/data/trees/chelicerate-16spec-astral-single-copy.tre)

```{r astral-single-tree-cds, out.width="75%", fig.align = "center", warning=FALSE}
...
```{r astral-single-tree-pep, out.width="75%", fig.align = "center", warning=FALSE}
...
other_trees = plot_grid(trad_tree_fig, ball_tree_fig, ncol=2)
print(other_trees)
```
