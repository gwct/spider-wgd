...
#infilename = here("docs", "data", "chelicerate_genomes-gwct.csv")
...
gene_p = ggplot(in_data, aes(x=Species.name, y=Genes)) +
...
transcript_p = ggplot(in_data, aes(x=Species.name, y=Transcripts)) +
